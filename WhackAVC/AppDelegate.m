...
- (void) applicationDidFinishLaunching:(UIApplication*)application
{
	...
	{
		UIAlertView *myAlert = [[[UIAlertView alloc] initWithTitle:@"No Internet Connection" message:@"Game runs in offline mode." delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil] autorelease];
		[myAlert show];
    ...
    else
    {
        ...
        [[KCSClient sharedClient] initializeKinveyServiceForAppKey:@"kid1566"
                                                     withAppSecret:@"1d2a2503dd354438bbbfaa559fb977e2"
                                                      usingOptions:nil];
